...
export const metadata: Metadata = {
  title: "Blog | Ditin Agrawal",
  metadataBase: new URL("https://ditinagrawal.netlify.app/blog"),
  description: "Read latest stories from Ditin Agrawal's Blog",
  openGraph: {
    title: "Blog | Ditin Agrawal",
    url: "https://ditinagrawal.netlify.app/blog",
    description: "Read latest stories from Ditin Agrawal's Blog",
  },
};
